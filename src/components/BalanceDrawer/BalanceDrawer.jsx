...
export const BalanceDrawer = ({ children, balances }) => {
      ...
      <div className="py-5">
        <table className="w-full">
          ...
          <tbody className="text-white/60">
            {balances.sort((a, b)=> b.effective_balance - a.effective_balance).map(({ symbol, effective_balance, balance }) => <tr key={symbol} className="flex flex-col py-3 border-b md:py-0 md:table-row md:border-none last:border-none border-b-primary-gray">
