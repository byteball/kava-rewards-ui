...
export const HowItWorks = () => (<div className="max-w-5xl px-6 mx-auto lg:px-8">
  ...
  <div className="flex flex-col items-center justify-between mt-10 space-x-5 md:flex-row">
    ...
    <div className="w-full md:w-[50%]">
      ...
      <div className="mt-5 space-y-2 text-white/80">
        <div>This works for any token that is listed on Coingecko and has a bridge to Obyte on <a href="https://counterstake.org" target="_blank" rel="noreferrer" className="underline text-kava">Counterstake</a>. If it doesn’t have a bridge yet, you can <a href="https://counterstake.org/create" target="_blank" rel="noreferrer" className="underline text-kava">add it</a>.</div>
  ...
  <div className="flex flex-col-reverse items-center justify-between mt-20 space-x-5 md:flex-row">
    <div className="w-full md:w-[50%]">
      ...
      <div className="mt-5 space-y-4">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-full shrink-0 bg-kava/20 text-white/60">2</div>
          <div>Use your GBYTE-on-Kava to borrow LINE tokens in the <a href="https://linetoken.org/" target="_blank" rel="noreferrer" className="underline text-kava">LINE dapp</a>.</div>
        </div>
  ...
  <div className="relative">
    ...
    <div className="flex flex-col items-center justify-between mt-20 md:space-x-5 md:flex-row">
      ...
      <div className="w-full md:w-[50%] space-y-4">
        <div>Kava distributes 1,000,000 KAVA tokens (about $1m) monthly to all dapps that participate in the <a href="https://www.kava.io/developer-rewards" target="_blank" rel="noreferrer" className="underline text-kava">Kava Rise program</a>. The program rewards for TVL, and our share of rewards depends on our share in the total <a href="https://defillama.com/chain/Kava" className="underline text-kava" target="_blank" rel="noreferrer">Kava TVL as tracked by DefiLlama</a>. It varies from month to month.</div>
  ...
  <div className="flex flex-col-reverse items-center justify-between mt-20 space-x-5 md:flex-row">
    <div className="w-full md:w-[50%] space-y-4">
      <div>First, <button onClick={() => changeNetwork()} className="underline cursor-pointer text-kava">add Kava</button> to your <a href="https://metamask.io/download" target="_blank" rel="noreferrer" className="underline text-kava">MetaMask</a>.</div>
      <div>Then, you’ll need a small amount of KAVA (the native token of Kava) in order to send transactions on the Kava network. You can buy KAVA on Binance and some other exchanges. When withdrawing KAVA to your MetaMask, use this <a href="https://docs.kava.io/docs/ethereum/address_conversion/" target="_blank" className="underline text-kava" rel="noreferrer">Kava address converter</a> to convert between EVM (your MetaMask) and Cosmos addresses on Kava.</div>
    </div>
