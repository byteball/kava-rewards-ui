export const Footer = () => (<div className="max-w-md mx-auto mt-10 md:max-w-2xl lg:px-8">
  <div className="flex flex-wrap justify-center space-x-5">
    <a className="p-2 hover:opacity-70" href="https://twitter.com/ObyteOrg" target="_blank" rel="noopener"><img src="/social_media/x.svg" alt="Obyte X (Twitter)" /></a>
  ...
  <div className="p-10 text-center text-white/40"><a href="https://obyte.org" target="_blank" rel="noopener">&copy; Obyte</a></div>
</div>)