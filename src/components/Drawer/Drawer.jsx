...
export const Drawer = ({ visible, setVisible, children, title = false }) => (<Transition.Root show={visible} as={Fragment}>
              ...
              <div className="flex flex-col h-full py-6 overflow-y-scroll shadow-xl bg-gray-950 ">
                <div className="px-4 sm:px-6">
                  <div className="flex items-start justify-between">
                    {title && <Dialog.Title className="text-base font-semibold leading-6 text-white">
                      {title}
                    </Dialog.Title>}
